...
const translations = {
  zh: {
    ...
    timeline: {
      ...
      calendarLead: "点击日历可在新窗口查看完整网页版。家长可以直接看到每周直播、阅读书目、项目节点与缓冲周安排。",
      calendarAria: ["打开 L1 网页版课程日历", "打开 L2 网页版课程日历"],
      calendarAlt: ["L1 课程日历", "L2 课程日历"],
      calendarOpen: ["打开网页版日历"],
      calendarTags: ["L1", "L2"],
      calendarTitles: ["Reading Program 网页版课程日历", "Reading Program 网页版课程日历"],
      calendarTexts: [
        "所有暑期与开学后 live class 统一调整到周六 11:30 AM-12:30 PM，周次与书目节奏保持一一对应。",
  ...
  en: {
    ...
    timeline: {
      ...
      calendarLead: "Click either calendar to open the full web calendar in a new tab. Families can see weekly live classes, books, project checkpoints, and buffer weeks at a glance.",
      calendarAria: ["Open the L1 web calendar", "Open the L2 web calendar"],
      calendarAlt: ["L1 class calendar", "L2 class calendar"],
      calendarOpen: ["Open web calendar"],
      calendarTags: ["L1", "L2"],
      calendarTitles: ["Editable Web Calendar", "Editable Web Calendar"],
      calendarTexts: [
        "All L1 summer and school-term live classes now meet on Saturdays from 11:30 AM to 12:30 PM, with the week-by-week book sequence preserved.",
